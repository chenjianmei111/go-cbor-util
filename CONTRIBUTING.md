...
1. Look through the [issues for this repo](https://github.com/chenjianmei111/go-cbor-util/issues) for relevant discussions.
...
1. If you like, check out [current PRs](https://github.com/chenjianmei111/go-cbor-util/pulls) to see how others do it.
